...
if (LIBSQUIDWCS_INCLUDE_DIR AND LIBSQUIDWCS_LIBRARIES)
  ...
  if (LIBSQUIDWCS_FOUND)
    ...
    STRING(REGEX REPLACE ".*#define LIBSQUIDWCS_VERSION[^0-9]*([0-9]+)\\.([0-9]+).*" "\\1.\\2" LIBSQUIDWCS_VERSION_STRING "${LIBSQUIDWCS_H}")
    STRING(REGEX REPLACE "^([0-9]+)[.]([0-9]+)" "\\1" LIBSQUIDWCS_VERSION_MAJOR ${LIBSQUIDWCS_VERSION_STRING})
    STRING(REGEX REPLACE "^([0-9]+)[.]([0-9]+)" "\\2" LIBSQUIDWCS_VERSION_MINOR ${LIBSQUIDWCS_VERSION_STRING})
    message(STATUS "found version string ${LIBSQUIDWCS_VERSION_STRING}")

    if (NOT LIBSQUIDWCS_FIND_QUIETLY)
      message(STATUS "Found LIBSQUIDWCS ${LIBSQUIDWCS_VERSION_MAJOR}.${LIBSQUIDWCS_VERSION_MINOR}: ${LIBSQUIDWCS_LIBRARIES}")
