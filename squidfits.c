...
int main(int argc, char *argv[]) {
   ...
   hidcount = 0;
   if (0 != wcs_getsquids(projection,wcs,cdelt,naxes,hres1,hidarr,ARR_MAX,&hidcount)) {
      fprintf(stderr,"wcs_getsquids failed in %s\n",argv[0]);
      exit(-1);
   }
